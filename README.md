# Polymer Portal Empleados JAPAC

Proyecto para portal interno de uso de consultas de empleados

El principal objetivo es que los empleados de Japac cuenten con una mecanismo 
de consulta de sus recibos de pago tanto en formato PDF como XML
